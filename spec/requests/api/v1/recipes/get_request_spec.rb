...
RSpec.describe "GET /api/v1/recipes", :vcr do
  describe "happy path" do
    ...
    describe "sad path" do
      it "selects a random country if no input is given" do
      ...
      it "returns empty array if no recipes are found" do
      ...
      it "returns an empty array if given emtpy string" do
        get "/api/v1/recipes", headers: {"CONTENT_TYPE" => "application/json"}, params: {q: ""}
